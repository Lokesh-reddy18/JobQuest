    ...
    <>
      ...
      <div className={`${scrolled ? "fixed animate-slideDown" : "relative"} top-0 left-0 right-0 z-10 w-full transition-all duration-300`}>
        <nav className={`transition-all duration-500 ${
          ...
          >
            <div className={`w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-600 flex items-center justify-center ${scrolled ? 'shadow-lg' : ''} group-hover:shadow-blue-500/30 transition-all duration-300`}>
