    ...
    >
      ...
      <section className="relative overflow-hidden mx-4 my-6 lg:mx-8 lg:my-10 rounded-3xl shadow-2xl">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-primary-900/90 to-secondary-800/90 mix-blend-multiply"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
          <div className="text-center">
            ...
            >
              Find Your <span className="text-accent-400">Dream Job</span>
              <br />
              With JobQuest
            </motion.h1>
            ...
            >
              <div className="flex flex-col md:flex-row">
                <div className="flex-1 flex items-center px-6 py-4 border-b md:border-b-0 md:border-r border-white/10">
                  <FiSearch className="text-white/60 text-xl mr-3" />
                  <input
                    type="text"
                    ref={titleRef}
                    placeholder="Job title, keywords, or company"
                    className="w-full text-lg outline-none bg-transparent text-white placeholder-white/60"
                    defaultValue={activeTag || ""}
                  />
                </div>
                <div className="flex-1 flex items-center px-6 py-4 border-b md:border-b-0 md:border-r border-white/10">
                  <FiMapPin className="text-white/60 text-xl mr-3" />
                  <input
                    type="text"
                    ref={locationRef}
                ...
                <button
                  type="submit"
                  className="bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 text-white px-8 py-4 font-semibold text-lg flex items-center justify-center transition-all duration-300"
                >
                  Search Jobs
      ...
      <motion.div
        ...
        className="relative bg-gradient-to-br my-10 from-background-light to-background-DEFAULT backdrop-blur-lg py-11 shadow-xl rounded-xl border border-white/20 mx-2 md:mx-7 lg:mx-20 xl:mx-8"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.p
            className="text-center text-text-DEFAULT font-medium mb-8 text-lg"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            {companyLogos.map((logo, index) => (
              ...
              >
                {/* Glow effect */}
                <div className="absolute inset-0 rounded-lg bg-primary-100/30 blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
